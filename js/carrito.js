...
function cargarProductosCarrito() {
    if (productosEnCarrito && productosEnCarrito.length > 0) {
        ...
        productosEnCarrito.forEach(producto => {
            ...
            div.innerHTML = `
                 <img class="carrito-producto-imagen" src="${producto.img}" alt="${producto.marca}">
                 <div class=" carrito-producto-titulo">
                   <p>${producto.nombre}</p>
                 </div>
                 <div class="arrito-producto-precio">
                 ...
                 <button id= "boton${producto.id}" class="btn btn-outline-dark carrito-producto-eliminar" > 
                    Eliminar</i>
                </button>
